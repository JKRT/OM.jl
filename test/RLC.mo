    ...
    package Analog  "Library for analog electrical models"
      ...
      package Interfaces  "Connectors and partial models for Analog electrical components"
        ...
        connector Pin  "Pin of an electrical component"
          Real v(final quantity = "ElectricPotential", final unit = "V") "Potential at the pin" annotation(unassignedMessage = "An electrical potential cannot be uniquely calculated.
        The reason could be that
        - a ground object is missing (Modelica.Electrical.Analog.Basic.Ground)
          to define the zero potential of the electrical circuit, or
        - a connector of an electrical component is not connected.");
          flow Real i(final quantity = "ElectricCurrent", final unit = "A") "Current flowing into the pin" annotation(unassignedMessage = "An electrical current cannot be uniquely calculated.
        The reason could be that
        - a ground object is missing (Modelica.Electrical.Analog.Basic.Ground)
          to define the zero potential of the electrical circuit, or
        - a connector of an electrical component is not connected.");
        ...
        partial model OnePort  "Component with two electrical pins p and n and current i from p to n"
          Real v(final quantity = "ElectricPotential", final unit = "V") "Voltage drop of the two pins (= p.v - n.v)";
          Real i(final quantity = "ElectricCurrent", final unit = "A") "Current flowing from pin p to pin n";
        ...
        partial model VoltageSource  "Interface for voltage sources"
          extends OnePort;
          parameter Real offset(final quantity = "ElectricPotential", final unit = "V") = 0 "Voltage offset";
      ...
      package Sources  "Time-dependent and controlled voltage and current sources"
        ...
        model SineVoltage  "Sine voltage source"
          parameter Real V(final quantity = "ElectricPotential", final unit = "V", start = 1) "Amplitude of sine wave";
